    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">PO</span>
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Gestao:</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('projectos.index') }}">
                            <i class="bi bi-circle"></i><span>Projectos</span>
                        </a>
                    </li>
                    {{-- <li>
                    ...
                    <li>
                        <a href="{{ route('descricoes.index') }}">
                            <i class="bi bi-circle"></i><span>Descricoes</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Forms Nav -->
